...
const ProductDetail = () => {
  // This is a sample product detail page that would be dynamically generated
  const productData = {
    title: 'Fast SYBR Green qPCR Master Mix',
        ...
        <section className="py-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                {/* Main Product Image */}
                <div className="w-full h-96 bg-gradient-to-br from-muted to-muted/50 rounded-lg flex items-center justify-center mb-4">
                  <div className="text-center text-muted-foreground/70">
                    <div className="w-20 h-20 mx-auto mb-4 rounded border-2 border-dashed border-current flex items-center justify-center">
                      <span className="text-sm">PROD</span>
                    </div>
                    <p className="text-sm">Main Product Image</p>
                  </div>
                </div>
              ...
              {/* Product Info */}
              <div>
                <Badge className="mb-4">{productData.category}</Badge>
                <h1 className="text-3xl font-bold text-foreground mb-4">{productData.title}</h1>
                
                <div className="space-y-4 mb-8">
                  <div className="flex items-center space-x-4">
                    <span className="font-medium text-foreground">Catalog #:</span>
                    <span className="text-muted-foreground">{productData.catalogNumber}</span>
                  </div>
                  <div className="flex items-center space-x-4">
                  ...
                  <div className="flex items-center space-x-4">
                    ...
                    <span className="text-2xl font-bold text-primary">{productData.listPrice}</span>
                  </div>
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="space-y-8">
                ...
                <Card>
                  ...
                  <CardContent>
                    <ul className="space-y-2">
                      {productData.manuals.map((manual, index) => (
                        <li key={index}>
